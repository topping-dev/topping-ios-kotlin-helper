...
/**
 * Provides the API for creating a KeyCycle Any for use in the Core
 * ConstraintLayout & MotionLayout system
 * This allows multiple KeyCycle positions to defined in one object.
 */
class KeyCycles internal constructor(numOfFrames: Int, vararg targets: String) :
    KeyAttributes(numOfFrames, *targets) {
    enum class Wave {
    ...
    protected override fun attributesToString(builder: StringBuilder) {
