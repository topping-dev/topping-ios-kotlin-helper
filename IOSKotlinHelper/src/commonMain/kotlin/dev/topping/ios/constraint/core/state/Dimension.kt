...
class Dimension {
    ...
    companion object {
        val FIXED_DIMENSION: Any = "FIXED_DIMENSION"
        val WRAP_DIMENSION: Any = "WRAP_DIMENSION"
        val SPREAD_DIMENSION: Any = "SPREAD_DIMENSION"
        val PARENT_DIMENSION: Any = "PARENT_DIMENSION"
        val PERCENT_DIMENSION: Any = "PERCENT_DIMENSION"
        val RATIO_DIMENSION: Any = "RATIO_DIMENSION"
