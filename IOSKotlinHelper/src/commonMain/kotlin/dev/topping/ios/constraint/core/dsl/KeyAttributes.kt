...
open class KeyAttributes internal constructor(numOfFrames: Int, vararg targets: String) :
    ...
    fun setVisibility(vararg visibility: Visibility) {
        this.visibility = visibility.toList().toTypedArray()
    }
    ...
    protected open fun attributesToString(builder: StringBuilder) {
        ...
        if (visibility != null) {
            builder.append("visibility:'").append(Arrays.toString(visibility)).append("',\n")
        }
