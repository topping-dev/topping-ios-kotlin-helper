...
class Flow : VirtualLayout() {
    ...
    private val mChainList: MutableList<WidgetsList> = mutableListOf()
    ...
    private var mDisplayedWidgets: Array<ConstraintWidget?> = arrayOf()
    ...
    override fun measure(widthMode: Int, widthSize: Int, heightMode: Int, heightSize: Int) {
        ...
        if (gone > 0) {
            widgets = arrayOfNulls<ConstraintWidget>(mWidgetsCount - gone)
            var j = 0
            for (i in 0 until mWidgetsCount) {
                val widget: ConstraintWidget? = mWidgets.get(i)
                if (widget?.visibility != GONE) {
    ...
    private inner class WidgetsList(
        ...
        fun createConstraints(isInRtl: Boolean, chainIndex: Int, isLastChain: Boolean) {
            ...
            for (i in 0 until count) {
                ...
                val widget: ConstraintWidget? = mDisplayedWidgets[mStartIndex + i]
                if (widget != null) {
                    widget.resetAnchors()
                }
            }
            ...
            if (mOrientation == HORIZONTAL) {
                ...
                if (mVerticalAlign == VERTICAL_ALIGN_BASELINE && verticalWidget?.hasBaseline() == false) {
                    for (i in 0 until count) {
                        var index = i
                        if (isInRtl) {
                            index = count - 1 - i
                ...
                for (i in 0 until count) {
                    ...
                    val widget: ConstraintWidget =
                        mDisplayedWidgets[mStartIndex + index] ?: continue
                    if (i == 0) {
                ...
                for (i in 0 until count) {
                    ...
                    val widget: ConstraintWidget = mDisplayedWidgets[mStartIndex + i] ?: continue
                    if (i == 0) {
    ...
    private fun measureChainWrap(
        ...
        var paddingLeft: Int = paddingLeft
        var paddingTop: Int = paddingTop
        var paddingRight: Int = paddingRight
        var paddingBottom: Int = paddingBottom
        var maxWidth = 0
        var maxHeight = 0
        ...
        for (i in 0 until listCount) {
            ...
            if (orientation == HORIZONTAL) {
                ...
                val currentBottom: ConstraintAnchor = current.mBiggest!!.mBottom
                current.setup(
                ...
                val currentRight: ConstraintAnchor = current.mBiggest!!.mRight
                current.setup(
                    orientation, left, top, right, bottom,
                    paddingLeft, paddingTop, paddingRight, paddingBottom, max
                )
    ...
    private fun measureAligned(
        ...
        if (orientation == HORIZONTAL) {
            ...
            if (cols <= 0) {
                ...
                for (i in 0 until count) {
                    ...
                    val widget: ConstraintWidget = widgets[i] ?: continue
        ...
        while (!done) {
            ...
            if (orientation == HORIZONTAL) {
                rows = ceil(count / cols.toFloat()).toInt()
            } else {
                cols = ceil(count / rows.toFloat()).toInt()
            }
            if (mAlignedBiggestElementsInCols == null
                ...
                Arrays.fillN(mAlignedBiggestElementsInCols!!, null)
            }
            ...
            for (i in 0 until cols) {
                for (j in 0 until rows) {
                    ...
                    val widget: ConstraintWidget = widgets[index] ?: continue
                    val w = getWidgetWidth(widget, max)
            ...
            var w = 0
            for (i in 0 until cols) {
                val widget: ConstraintWidget? = mAlignedBiggestElementsInCols!![i]
                if (widget != null) {
                    if (i > 0) {
                        w += mHorizontalGap
                    }
            ...
            var h = 0
            for (j in 0 until rows) {
                val widget: ConstraintWidget? = mAlignedBiggestElementsInRows!![j]
                if (widget != null) {
                    if (j > 0) {
                        h += mVerticalGap
                    }
    ...
    private fun createAlignedConstraints(isInRtl: Boolean) {
        ...
        for (i in 0 until mDisplayedWidgetsCount) {
            val widget: ConstraintWidget? = mDisplayedWidgets[i]
            widget!!.resetAnchors()
        }
        ...
        for (i in 0 until cols) {
            ...
            val widget: ConstraintWidget? = mAlignedBiggestElementsInCols!![index]
        ...
        for (i in 0 until cols) {
            for (j in 0 until rows) {
                ...
                val widget: ConstraintWidget? = mDisplayedWidgets[index]
                if (widget == null || widget.visibility == GONE) {
                    continue
                }
                val biggestInCol: ConstraintWidget? = mAlignedBiggestElementsInCols!![i]
                val biggestInRow: ConstraintWidget? = mAlignedBiggestElementsInRows!![j]
