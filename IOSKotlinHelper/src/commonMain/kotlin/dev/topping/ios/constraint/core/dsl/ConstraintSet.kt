...
/**
 * Provides the API for creating a ConstraintSet Any for use in the Core
 * ConstraintLayout & MotionLayout system
 */
class ConstraintSet(private val mName: String) {
    var mConstraints: MutableList<Constraint> = mutableListOf()
    var mHelpers: MutableList<Helper> = mutableListOf()
