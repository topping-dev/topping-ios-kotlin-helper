...
class OnSwipe {
    ...
    override fun toString(): String {
        ...
        if (touchAnchorSide != null) {
            ret.append("side:'").append(touchAnchorSide.toString().lowercase()).append("',\n")
        }
