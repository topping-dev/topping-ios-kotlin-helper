 ...
 */
class Metrics {
    var measuresWidgetsDuration // time spent in child measures in nanoseconds
            : Long = 0
    var measuresLayoutDuration // time spent in child measures in nanoseconds
            : Long = 0
    ...
    var layouts: Long = 0
    var grouping: Long = 0
    var mNumberOfLayouts // the number of times ConstraintLayout onLayout gets called
            = 0
    var mNumberOfMeasures // the number of times child measures gets called
            = 0
    var mMeasureDuration // time spent in measure in nanoseconds
            : Long = 0
    var mChildCount // number of child Views of ConstraintLayout
            : Long = 0
    var mMeasureCalls // number of time CL onMeasure is called
            : Long = 0
